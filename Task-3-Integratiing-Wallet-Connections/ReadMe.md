...
- Node v18 or above
- Chrome Browser
- Puzzle Wallet Extension Inside Chrome Browser
- Create Account in Puzzle Wallet


## Setup Project:
- Command:
    ```sh
    npx create-react-app sandabgc_wallet_integration_aleo_dapp
    cd sandabgc_wallet_integration_aleo_dapp
    npm install aleo-adapters aleo-hooks
    ```

- Make sure react version is `18.2.15`:
    ```sh
    "react": "^18.2.15",
    "react-dom": "^18.2.15",
    ```
...
- Create new file named `Header.jsx` under `src/components` with below code:
...
- Create new file named `WalletModal.jsx` under `src/components` with below code:
    <details><summary> Detailed Output </summary><blockquote>
...
- Create new file named `WalletModal.css` under `src` with below code:
    <details><summary> Detailed Output </summary><blockquote>
...
- Create `assets` folder under `src`.
- Download icon for each wallets of leo, puzzle, soter and fox inside `src/assets` folder.
- Overwrite `App.js` inside `src` with below code:
    ...
    return (
        <header className="app-header">
        <div className="logo">
            Sandab GC DApp: Integrating Wallet Connections
        </div>
