...
function App() {
  ...
  const testUsage = async () => {
    ...
    const txId = "at1gm5det369mee7k0tjrs4ms88sc6nncts855t4udnjx0svk68hsrs9cdwrk";

    const resultTxId = await aleoWorker.testUsage(privateKey, txId, inputs[1], "100u128", inputs, 1);
    console.log("Transactionn ID: " + resultTxId);
  }
